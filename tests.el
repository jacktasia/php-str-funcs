...
(deftest "php-str-replace with lists" (assert-equal "hello gold" (php-str-replace '("bye" "wor") 
																				  '("hello" "go")
																				  "bye world")))

(deftest "php-str-replace with strings" (assert-equal "asdfware" (php-str-replace "gold" "asdf"
																				  "goldware")))
